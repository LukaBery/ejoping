...
public class QReviewImage extends EntityPathBase<ReviewImage> {
    ...
    private static final long serialVersionUID = -327404576L;
    ...
    public final com.nhnacademy.bookstore.review.entity.QReview review;
    ...
    public QReviewImage(Class<? extends ReviewImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new com.nhnacademy.bookstore.review.entity.QReview(forProperty("review"), inits.get("review")) : null;
    }
